...
if __name__ == "__main__":
    ...
    # Load trained FP16 weights (set weights_only=False if needed)
    checkpoint = torch.load(
        "/home/ml/Desktop/shubham/sensors/RS/models/best_emotion_model_fp16.pth",
        map_location="cpu",
        weights_only=False
    )
    ...
    scripted_model.save("/home/ml/Desktop/shubham/sensors/RS/models/emotion_cnn_scripted_fp16.pt")

    traced_model = torch.jit.trace(model, torch.randn(1, 3, 48, 48).half())
    traced_model.save("/home/ml/Desktop/shubham/sensors/RS/models/emotion_cnn_traced_fp16.pt")

    print("✅ TorchScript FP16 models saved.")
    ...
    input_tensor = transform(img).unsqueeze(0).half()  # convert input to FP16

    # Load back scripted model for inference
    ts_model = torch.jit.load("/home/ml/Desktop/shubham/sensors/RS/models/emotion_cnn_scripted_fp16.pt")
    ts_model.eval()
